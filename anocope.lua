function newLibrary()
    ...
    function util:CreateFolderTab(folderName, items)
        ...
        local titleHolder = util:Create('Frame', {
            Name = "TitleHolder", Parent = folder, AnchorPoint = Vector2.new(0.5, 0.5), BackgroundColor3 = Color3.fromRGB(36, 36, 36), BorderColor3 = Color3.fromRGB(0, 0, 0), BorderSizePixel = 0, Position = UDim2.new(0.5, 0, 0.5, 0), Size = UDim2.new(0, 196, 0, 21), ZIndex = 1})
        local title = util:Create('TextLabel', {
            ...
            util:Create('UIGradient', {util:Create('UIGradient', {Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200,200,200)), ColorSequenceKeypoint.new(0.87, Color3.fromRGB(255,255,255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200,200,200))}, Rotation = -90, Parent = titleHolder})})
        })
    end
