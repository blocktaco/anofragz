    ...
    function util:CreateFolderTab(folderName, items)
        ...
        local title = util:Create('TextLabel', {
            ...
            util:Create('UIGradient', {
                Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(200, 200, 200)), ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(200, 200, 200))}, Rotation = 90
            }),
        })
