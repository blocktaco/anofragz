function newLibrary()
    ...
    function util:CreateFolderTab(folderName, items)
        ...
        local title = util:Create('TextLabel', {
            ...
            util:Create('UIGradient', {Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200,200,200)), ColorSequenceKeypoint.new(0.87, Color3.fromRGB(255,255,255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200,200,200))}, Rotation = -90, Parent = titleHolder})
        })
    end
