    ...
    function util:CreateFolderTab(folderName, items)
        ...
        --[[button.MouseButton1Click:Connect(function()
            if holder.BackgroundTransparency == 0 then
                ...
                wait(0.35)
                tweenService:Create(holder, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Position = UDim2.new(0.5, 0, 0.994, 0), Size = UDim2.new(0,196,0,0)}):Play()
                wait(0.15)	
                ...
                tweenService:Create(holder, TweenInfo.new(0.15, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Position = UDim2.new({0.5, 0},{9.667, 0}), Size = UDim2.new(0,196,0,365)}):Play()
                wait(0.2)
                for i,v in pairs(holder:GetDescendants()) do
                    if v.ClassName == 'TextLabel' then
